...
line ""
line "Circulation comes from Koha alone. PMB implements loan, reservation"
line "and reader services and ships them disabled in its own"
line "external_services/catalog.xml (ids 24-26), so no PMB installation"
line "exposes them; see docs/pmb-setup.md."
printf '\n'
